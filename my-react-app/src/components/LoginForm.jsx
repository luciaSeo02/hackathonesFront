...
const LoginForm = () => {
    ...
    return !token ? (
        <div className="bg-light-gradient dark:bg-dark-gradient p-2.5 flex justify-center items-center">
            <section className="bg-white p-10 rounded-2xl flex flex-col justify-center items-center gap-6 sm:w-2/5">
                <div className="bg-neutral-100 size-11 p-2 rounded-md flex justify-center items-center shadow-md sm:size-16 sm:p-5 sm:rounded-lg">
                ...
                >
                    <div className="bg-neutral-100 w-full px-3 py-2 rounded-lg flex justify-start items-center gap-2">
                        <Mail size={14} />
